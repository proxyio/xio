...
int producer_psend_request(producer_t *io, const char *data, int64_t size);
int producer_precv_response(producer_t *io, char **data, int64_t *size);
...
int comsumer_psend_response(comsumer_t *io, const char *data, int64_t size,
			    const char *rt, int64_t rt_size);
int comsumer_precv_request(comsumer_t *io, char **data, int64_t *size,
			   char **rt, int64_t *rt_size);
