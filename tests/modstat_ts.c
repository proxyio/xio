...
static void s_warn(struct mstats_base* stb, int sl, int key, i64 ts, i64 val, i64 min_val,
                   i64 max_val, i64 avg_val) {
}
static void m_warn(struct mstats_base* stb, int sl, int key, i64 ts, i64 val, i64 min_val,
                   i64 max_val, i64 avg_val) {
}
static void h_warn(struct mstats_base* stb, int sl, int key, i64 ts, i64 val, i64 min_val,
                   i64 max_val, i64 avg_val) {
}
static void d_warn(struct mstats_base* stb, int sl, int key, i64 ts, i64 val, i64 min_val,
                   i64 max_val, i64 avg_val) {
}
